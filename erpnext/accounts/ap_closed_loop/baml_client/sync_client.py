...
class BamlSyncClient:
    ...
    def ReadReceipt(self, doc: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ReadReceipt", args={
                "doc": doc,
            })
    ...
    def ReadReceiptPdf(self, doc: baml_py.Pdf,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ReadReceiptPdf", args={
                "doc": doc,
            })
            return typing.cast(types.Receipt, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ReadReceipt(self, doc: baml_py.Image,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ReadReceipt", args={
            "doc": doc,
        })
    ...
    def ReadReceiptPdf(self, doc: baml_py.Pdf,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ReadReceiptPdf", args={
            "doc": doc,
        })
        return baml_py.BamlSyncStream[stream_types.Receipt, types.Receipt](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ReadReceipt(self, doc: baml_py.Image,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ReadReceipt", args={
            "doc": doc,
        }, mode="request")
        return __result__
    def ReadReceiptPdf(self, doc: baml_py.Pdf,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ReadReceiptPdf", args={
            "doc": doc,
        }, mode="request")
        return __result__
