...
class BamlAsyncClient:
    ...
    async def ReadReceipt(self, doc: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> types.Receipt:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ReadReceipt(doc=doc,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ReadReceipt", args={
                "doc": doc,
            })
            return typing.cast(types.Receipt, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def ReadReceiptPdf(self, doc: baml_py.Pdf,
        baml_options: BamlCallOptions = {},
    ) -> types.Receipt:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ReadReceiptPdf(doc=doc,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ReadReceiptPdf", args={
                "doc": doc,
            })
            return typing.cast(types.Receipt, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ReadReceipt(self, doc: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Receipt, types.Receipt]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ReadReceipt", args={
            "doc": doc,
        })
    ...
    def ReadReceiptPdf(self, doc: baml_py.Pdf,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Receipt, types.Receipt]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ReadReceiptPdf", args={
            "doc": doc,
        })
        return baml_py.BamlStream[stream_types.Receipt, types.Receipt](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def ReadReceipt(self, doc: baml_py.Image,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ReadReceipt", args={
            "doc": doc,
        }, mode="request")
        return __result__
    async def ReadReceiptPdf(self, doc: baml_py.Pdf,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ReadReceiptPdf", args={
            "doc": doc,
        }, mode="request")
        return __result__
